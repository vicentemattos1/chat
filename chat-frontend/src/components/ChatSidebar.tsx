  ...
  return (
    <Sidebar className="bg-chat-sidebar border-r border-sidebar-border">
      <SidebarHeader className="p-4 border-b border-sidebar-border">
        <Button 
          onClick={onNewChat}
          className="w-full bg-sidebar-accent hover:bg-purple-500/50 text-sidebar-accent-foreground hover:text-sidebar-primary-foreground transition-colors duration-fast group"
        >
