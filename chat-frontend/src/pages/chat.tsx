  ...
  const [chats, setChats] = useState<Chat[]>([
    {
      ...
      messages: [
        ...
        },
        {
          id: '2',
          content:
            "I'd be happy to help you understand React components! React components are the building blocks of React applications. They're JavaScript functions or classes that return JSX (JavaScript XML) to describe what should appear on the screen.\n\nHere are the key concepts:\n\n**Function Components** (most common):\n```jsx\nfunction Welcome(props) {\n  return <h1>Hello, {props.name}!</h1>;\n}\n```\n\n**Key features:**\n- **Reusable**: Write once, use anywhere\n- **Composable**: Combine simple components to build complex UIs\n- **Props**: Pass data from parent to child components\n- **State**: Manage component's internal data\n\nWould you like me to explain any of these concepts in more detail?",
          role: 'assistant',
      ...
      messages: [
        {
          id: '3',
          content:
            'What are some TypeScript best practices for React development?',
          role: 'user',
  ...
  const addMessage = (content: string) => {
    ...
    setTimeout(() => {
      const aiResponse: Message = {
        ...
        content:
          "I understand your question. This is a simulated response - in a real application, this would connect to an AI service like OpenAI's GPT API to provide intelligent responses based on your input.",
        role: 'assistant',
        timestamp: new Date(),
      }
    ...
    <div className="flex h-screen w-full bg-chat-main">
      <SidebarProvider defaultOpen={true}>
        <div className="flex h-full w-screen">
          ...
          <ChatMain chat={getCurrentChat()} onSendMessage={addMessage} />
        </div>
      </SidebarProvider>
    </div>
  )
